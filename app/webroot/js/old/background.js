$(function(){
	...
	// preload the images
	var backgroundOne = new PreLoadedImage("/img/top-background.jpg","TevaOne","top-background",".background","top-background");
	var backgroundTwo = new PreLoadedImage("/img/bottom-background.jpg","TevaOne","bottom-background",".background","bottom-background");
