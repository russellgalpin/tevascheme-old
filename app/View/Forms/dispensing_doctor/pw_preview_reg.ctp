...
// Meta data
$this->set('title_for_layout', 'PriceWatch Preview Registration | Dispensing Doctor');
...
<div class="main-content span12 center relative">
    ...
    <form action="/forms/pw_preview_submit" id="preview-reg-form" enctype="multipart/form-data" method="post" class="relative high-z">
        <input type="hidden" name="form-name" value="Dispensing Doctor PriceWatch Preview Registration Form" />
