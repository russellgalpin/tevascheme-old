...
echo $this->Html->script('DD_sign_up.js');

// Meta data
$this->set('title_for_layout', 'Sign Up | Dispensing Doctor');
$this->set('meta_description', 'Teva Scheme Sign Up - Dispensing Doctor');
?>
...
?>
    ...
    <div class="form-top">
        ...
        <form action="#" id="sign-up-form" enctype="multipart/form-data" method="post">
            <input type="hidden" name="form-name" value="Dispensing Doctor Teva scheme sign up" />
            <input type="hidden" name="form-website" value="dispensing_doctor" />
            <fieldset>
                <!-- section one -->
                <div class="section section-one shown margin-left">
            ...
            <div class="section section-two hidden">
                ...
                <p>
                    ...
                    <select name="buying-groups" id="buying-groups" class="custom-select">
                        ...
                        <option value="Alliance Forte">Alliance/Forte</option>
                    </select>
                </p>
            ...
            <div class="section section-three hidden">
                ...
                <p>Insert up to three Wholesalers</p>
                <!-- wholesaler one -->
                <div class="w-one-wrapper margin-bottom">
                    <p class="margin-bottom">
            ...
            <div class="section section-five hidden">
                ...
                <p class="margin-bottom">
                    <p class="red hidden" id="confirmation-error">Please confirm permission to continue with the Teva Scheme sign up, as this data is required for scheme administration purposes.</p>
                    <p>
                    <input type="checkbox" name="confirmation" id="confirmation" value="Yes" class="block span-end float-left"">
                    I hearby confirm permission for the nominated wholesaler to provide data on the sales of Teva UK Limited products to Teva UK Limited. Data will be provided on a daily and monthly basis and will only be used for the operation and monitoring of the Teva UK Limited Schemes. *</p>
                    <span class="block clear"></span>
                </p>
            ...
            <div class="section section-seven hidden">
                ...
                <p>You have 7 working days to finalise your Teva Scheme sign up.</p>
                    <a href="/dispensing-doctor/sign-up"><input type="button" value="Add another branch" class="lrg-button span-end sign-up-link-plain btn-primary"></a>
					<a href="/dispensing-doctor/home"><input type="button" value="Return to homepage" class="lrg-button teva-one-link-plain btn-primary"></a>				
                </p>
                </div>
			</fieldset>
    </form>
