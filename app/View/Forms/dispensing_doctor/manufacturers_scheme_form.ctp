...
// Meta data
$this->set('title_for_layout', 'TevaOne Manufacturers Scheme Sign Up | Dispensing Doctor');
$this->set('meta_description', 'TevaOne Manufacturers Scheme Sign Up - Dispensing Doctor');
?>

<section class="dialog-container">
	<div class="dialog">
		<div class="main-dialog">
			<img src="/img/teva-one-logo.svg" alt="Teva One" class="logo" />
