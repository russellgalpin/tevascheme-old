...
// Meta data
$this->set('title_for_layout', 'Generics Patient Communication Kit Order Form');
$this->set('meta_description', 'Generics Patient Communication Kit Order Form');
?>
...
?>
    ...
    <div class="form-top">
    <h1 class="form-title margin-bottom">Generics Patient Communication Kit Order Form</h1>
    ...
    <h2>To order your Generics Patient Communication Kit, simply fill out the form below or for more information call <br>0800 389 4644</h2>
    <!-- error notice -->
    <p class="margin-bottom red hidden" id="error-note">Please complete all mandatory fields, indicated in red</p>	
    <!-- cms advantage form -->
    </div>
    <form action="/forms/generics_patient_comm_kit_submit" id="advantage-form" enctype="multipart/form-data" method="post" class="margin-left relative high-z">
        <input type="hidden" name="form-name" value="Dispensing Doctor Generics Patient Communication Kit Order Form" />
        ...
        <fieldset>
            ...
            <div class="float-left margin-left">
                <p class="margin-bottom">
                    <label for="del-name-address" class="block">Delivery Address if different to Practice</label>
            ...
            <p class="span10 margin-bottom">
                ...
                <label for="opt-criteria">I meet the criteria to receive the Generics Patient Communication kit free of charge</label>
            </p>
            <p class="span10 margin-bottom">
                <input type="radio" name="opt-meet-criteria" value="0" id="opt-contact-payment" value="opt-contact-payment">
                <label for="opt-contact-payment">Please contact me to arrange payment of &pound;30</label>
            </p>
