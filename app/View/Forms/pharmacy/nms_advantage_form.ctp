...
// Meta data
$this->set('title_for_layout', 'NMS Advantage Order Form');
$this->set('meta_description', 'NMS Advantage Order Form');
?>
...
?> 
    ...
    <div class="form-top">
    <h1 class="form-title margin-bottom">NMS Advantage Order Form</h1>
    ...
    <h2>To order your NMS Advantage kit, simply fill out the form below or for more information call 0800 389 4644</h2>
    <!-- error notice -->
    ...
    <form action="/forms/advantage_form_submit" id="advantage-form" enctype="multipart/form-data" method="post" class="margin-left relative high-z">
        <input type="hidden" name="form-name" value="NMS Advantage Order Form" />
        <fieldset>
            ...
            <p class="span10 margin-bottom">
                ...
                <label for="opt-criteria">I meet the criteria to receive the NMS Advantage kit free of charge</label>
            </p>
            <p class="span10 margin-bottom">
