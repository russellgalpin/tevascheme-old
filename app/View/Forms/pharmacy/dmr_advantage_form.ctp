...
// Meta data
$this->set('title_for_layout', 'DMR Advantage Order Form');
$this->set('meta_description', 'DMR Advantage Order Form');
?>
...
?> 
    ...
    <div class="form-top">
    <h1 class="form-title margin-bottom">DMR Advantage Order Form</h1>
    ...
    <h2>To order your DMR Advantage kit, simply fill out the form below or for more information call 0800 389 4644</h2>
    <!-- error notice -->
    <p class="margin-bottom red hidden" id="error-note">Please complete all mandatory fields, indicated in red</p>	
    <!-- cms advantage form -->
    </div>
    <form action="/forms/advantage_form_submit" id="advantage-form" enctype="multipart/form-data" method="post" class="margin-left relative high-z">
        <input type="hidden" name="form-name" value="DMR Advantage Order Form" />
        <fieldset>
            ...
            <p class="span10 margin-bottom">
                ...
                <label for="opt-criteria">I meet the criteria to receive the DMR Advantage kit free of charge</label>
            </p>
            <p class="span10 margin-bottom">
