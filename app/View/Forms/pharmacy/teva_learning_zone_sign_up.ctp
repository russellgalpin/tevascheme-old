...
?> 
    ...
    <form action="/forms/teva_learning_zone_submit" id="advantage-form" enctype="multipart/form-data" method="post" class="margin-left relative high-z">
        <input type="hidden" name="form-name" value="Pharmacy Support Teva Learning Zone Sign Up" />
        ...
        <fieldset>
            ...
            <p class="bold-italic">
				Please select which Teva Learning Zone skills package you would like access to:</p>
