...
?>
    ...
    <h2>To order your Generics Patient Communication Kit, simply fill out the form below or for more information call 0800 389 4644</h2>
    <!-- error notice -->
    ...
    <form action="/forms/generics_patient_comm_kit_submit" id="advantage-form" enctype="multipart/form-data" method="post" class="margin-left relative high-z">
        <input type="hidden" name="form-name" value="Pharmacy Support Generics Patient Communication Kit Order Form" />
