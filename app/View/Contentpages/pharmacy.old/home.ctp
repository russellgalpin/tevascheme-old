...
// echo $this->Html->script('support_services.js');
?>
			...
			<div class="inner-wrapper" id="headingOne">
				...
				<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
					<div class="content card-body">
						<h3>New lower net price & higher monthly rebate</h3>
						<p>Generics that are lower priced to begin with, before any discounts are applied and a simpler rebate structure, makes it all the more transparent to see what you can finally spend and earn.</p>
					</div>
					<img src="/img/roundalls-1.svg" alt="Roundalls">
				</div>
			</div>
		</div>
	</article>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingTwo">
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
					<div class="content card-body">
						<h3>Convenient choice of over 740 product lines</h3>
					...
					<img src="/img/roundalls-2.svg" alt="Roundalls">
				</div>
			</div>
		</div>
	</article>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingThree">
				...
				<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
					...
					<img src="/img/roundalls-3.svg" alt="Roundalls">
				</div>
			</div>
		</div>
	</article>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingFour">
				...
				<div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
					...
					<img src="/img/roundalls-4.svg" alt="Roundalls">
				</div>
			</div>
		</div>
	</article>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingSix">
				...
				<div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
					...
					<img src="/img/roundalls-2.svg" alt="Roundalls">
					<a href="/support/"><button class="btn-primary">Go to Pharmacy Support</button></a>
				</div>
			</div>
		</div>
	</article>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingSeven">
				...
				<div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
					...
					<img src="/img/roundalls-1.svg" alt="Roundalls">
					<a href="#"><button class="btn-primary">Go to YourTeva</button></a>
				</div>
			</div>
		</div>
	</article>
...
jQuery(document).ready(function($){
	$('.slider-nav').slick('slickGoTo',<?php echo $slideNum; ?>);
});
</script>
<?php
	}
