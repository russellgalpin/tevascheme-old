...
<div class="flex row">
	<div class="col-ts-1-2">
		<figure class="teva-logo">
			<img src="/img/teva-one-logo-orange.svg" alt="Teva One" />
		</figure>
	</div>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingThree">
				...
				<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
					<div class="content card-body">
						<h3>Consistent quality and packaging design to aid dispensing and patient loyalty</h3>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingFive">
				...
				<div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
					<div class="card-body">
						<img class="full-width" src="/img/spend-graph-dd.png" alt="Spend Graph">
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingSix">
				<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
					<h2>Dispensing Doctor Support<span class="open-close"></span></h2>
				</button>
				...
				<div class="service">
					...
					<a href="/dispensing-doctor/support/"><button class="btn-primary">Go to Dispensing Doctor Support</button></a>
				</div>
				</div>
			</div>
		</div>
		...
		<div class="outer-wrapper accordion" id="accordionExample">
			<div class="inner-wrapper" id="headingSeven">
				...
				<div class="service">
					...
					<a href="https://www.yourteva.com/Login" target="_blank"><button class="btn-primary">Go to YourTeva</button></a>
				</div>
				</div>
			</div>
		</div>
