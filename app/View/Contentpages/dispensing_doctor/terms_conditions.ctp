...
if(($content['Contentpage']['footer']!= null)&&($content['Contentpage']['footer']!= "")){
	...
	echo '<p class="smaller-text">Registered in England No. 302461. Registered office: Ridings Point, Whistler Drive, Castleford, WF10 5HX United Kingdom. UK/SCH/17/0030</p>
    <p class="smaller-text">Date of Preparation: December 2017</p>';
}
?>
</div>
</div>